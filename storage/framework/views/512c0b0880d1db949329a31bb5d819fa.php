...
@media(max-width: 480px) {
    ...
    <div class="pb-trust__bg" style="background-image: url('<?php echo e(asset('assets/img/school/olympics/peekaboo-056.jpeg')); ?>');">
        ...
        <div class="pb-trust__content wow itfadeUp" data-wow-duration=".9s">
            ...
            <div class="pb-trust__signals">
                ...
                <div class="pb-trust__signal wow itfadeUp" data-wow-delay="0.2s">
                    ...
                    <span class="pb-trust__signal-value"><?php echo e(date('Y') - 2010); ?>+</span>
            ...
            <div class="pb-trust__actions">
                <a href="<?php echo e(route('book-tour')); ?>" class="pb-trust__cta-primary">
    ...
    <div class="container">
        ...
        <div class="pb-gallery wow itfadeUp" data-wow-delay="0.3s">
            <div class="pb-gallery__grid" id="peekabooGallery">
                ...
                <?php $__currentLoopData = $sortedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(asset($baseUrl . '/' . $item['src'])); ?>"
                       class="pb-gallery__item popup-image"
                       data-category="<?php echo e($item['cat']); ?>"
                       title="<?php echo e($item['alt']); ?>">
                        <img src="<?php echo e(asset($baseUrl . '/' . $item['src'])); ?>"
                ...
                <?php $__currentLoopData = $videoFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vi => $vidSrc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="pb-gallery__item pb-gallery__item--video"
                         data-category="videos"
                         data-video-src="<?php echo e(asset($baseUrl . '/' . $vidSrc)); ?>">
                        <video class="pb-gallery__thumb-video" muted playsinline preload="metadata">
                            <source src="<?php echo e(asset($baseUrl . '/' . $vidSrc)); ?>#t=0.5" type="video/mp4">
                        </video>
