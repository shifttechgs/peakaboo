...
<div class="row g-4 mb-4">
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <div class="value text-primary"><?php echo e($recentUsers->count()); ?></div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <div class="value text-success"><?php echo e($recentUsers->whereNull('deleted_at')->count()); ?></div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <div class="value text-danger"><?php echo e($recentUsers->whereNotNull('deleted_at')->count()); ?></div>
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <div class="value" style="color:#7c3aed;">
                        <?php echo e($recentUsers->where('created_at', '>=', now()->subDays(7))->count()); ?>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center gap-3">
                            <div class="al-avatar" style="background:<?php echo e($bgColor[$idx]); ?>"><?php echo e($initial); ?></div>
                            <span class="fw-semibold" style="color:#1a1f2e;"><?php echo e($u->name); ?></span>
                        </div>
                    </td>
                    <td style="color:#6c757d;font-size:.82rem;"><?php echo e($u->email); ?></td>
                    <td>
                        <?php if($isDeleted): ?>
                    ...
                    <td style="font-size:.8rem;color:#94a3b8;">
                        <?php echo e(\Carbon\Carbon::parse($u->created_at)->format('d M Y')); ?>

                    </td>
                    <td style="font-size:.8rem;color:#94a3b8;">
                        <?php echo e(\Carbon\Carbon::parse($u->updated_at)->diffForHumans()); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64_3.3.4\www\projects\peekaboo\resources\views/admin/settings/audit-log.blade.php ENDPATH**/ ?>