    ...
    <div class="col-lg-8">
        ...
        <div class="panel" style="overflow:visible;">
            ...
            <div style="padding:22px 24px;display:flex;align-items:center;gap:20px;">
                <div class="profile-avatar"><?php echo e(strtoupper(mb_substr($parent->name, 0, 1))); ?></div>
                <div class="flex-grow-1">
                    <div style="font-size:1.1rem;font-weight:800;color:#1a1f2e;letter-spacing:-.2px;"><?php echo e($parent->name); ?></div>
                    <div style="font-size:.8rem;color:#94a3b8;margin-top:2px;"><?php echo e($parent->email); ?></div>
                    <div style="margin-top:8px;display:flex;gap:8px;flex-wrap:wrap;">
                        ...
                        <span style="font-size:.67rem;font-weight:700;background:#f8faff;color:#64748b;border-radius:999px;padding:3px 11px;border:1px solid #e2e8f0;">
                            <i class="fas fa-calendar me-1"></i> Member since <?php echo e($parent->created_at->format('M Y')); ?>
        ...
        <div class="panel">
            ...
            <div style="padding:22px 24px;">
                <form method="POST" action="<?php echo e(route('parent.profile.update')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="field-lbl">Full Name</div>
                            <input type="text" name="name"
                                   class="form-control form-control-premium <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('name', $parent->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" name="email"
                                   class="form-control form-control-premium <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('email', $parent->email)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="tel" name="phone"
                                   class="form-control form-control-premium <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('phone', $parent->phone)); ?>"
    ...
    <div class="col-lg-4">
        ...
        <div class="panel" style="margin-bottom:24px;">
            <div style="padding:18px 22px 14px;">
                ...
                <div style="font-size:.92rem;font-weight:800;color:#1a1f2e;"><?php echo e($parent->name); ?></div>
            </div>
            <div class="stat-row">
                <div class="stat-tile">
                    <div class="st-val"><?php echo e($children->where('status','approved')->count()); ?></div>
                    <div class="st-lbl">Enrolled</div>
                </div>
                <div class="stat-tile">
                    <div class="st-val"><?php echo e($children->whereIn('status',['pending','under_review'])->count()); ?></div>
                    <div class="st-lbl">Pending</div>
                </div>
                <div class="stat-tile">
                    <div class="st-val"><?php echo e($children->count()); ?></div>
        ...
        <div class="panel">
            ...
            <div class="info-row">
                <div class="info-icon"><?php echo e(strtoupper(mb_substr($child['name'], 0, 1))); ?></div>
                <div class="flex-grow-1">
                    <div class="info-val"><?php echo e($child['name']); ?></div>
                    <?php if($child['child_number']): ?>
                        <div class="info-lbl"><code style="font-size:.7rem;color:#0077B6;"><?php echo e($child['child_number']); ?></code></div>
                    <?php endif; ?>
                </div>
                <span style="font-size:.67rem;font-weight:700;border-radius:999px;padding:3px 9px;
                      background:<?php echo e($child['status']==='approved' ? '#dcfce7' : '#fff7ed'); ?>;
                      color:<?php echo e($child['status']==='approved' ? '#16a34a' : '#d97706'); ?>;">
        ...
        <div style="display:flex;flex-direction:column;gap:10px;">
            <a href="<?php echo e(route('parent.fees.statements')); ?>" class="qa-link">
                <div class="qa-icon"><i class="fas fa-receipt"></i></div>
                View Statement
            </a>
            <a href="<?php echo e(route('parent.documents')); ?>" class="qa-link">
                <div class="qa-icon"><i class="fas fa-folder-open"></i></div>
                Document Vault
            </a>
            <a href="<?php echo e(route('parent.children')); ?>" class="qa-link">
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64_3.3.4\www\projects\peekaboo\resources\views/parent/profile.blade.php ENDPATH**/ ?>