    ...
    <aside class="sb" id="sidebar">
        ...
        <nav class="sb-nav">
            ...
            <a href="<?php echo e(route('admin.crm.index')); ?>" class="sb-link <?php echo e(request()->routeIs('admin.crm.*') ? 'active' : ''); ?>">
                ...
                <?php if($overdueLeads > 0): ?><span class="sb-count"><?php echo e($overdueLeads); ?></span><?php endif; ?>
            </a>
                ...
                <div class="dropdown">
                    <button class="hdr-icon-btn" data-bs-toggle="dropdown" aria-expanded="false" title="Notifications">
                        ...
                        <?php if($unreadCount > 0): ?>
                            <span class="notif-count-badge"><?php echo e($unreadCount > 9 ? '9+' : $unreadCount); ?></span>
                        <?php endif; ?>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end notif-dropdown">
                        <div class="notif-dropdown-head">
                            <span class="title">Notifications <?php if($unreadCount > 0): ?><span style="color:#94a3b8;font-weight:500;">(<?php echo e($unreadCount); ?> new)</span><?php endif; ?></span>
                            <?php if($unreadCount > 0): ?>
                                <form method="POST" action="<?php echo e(route('admin.notifications.mark-all-read')); ?>" style="margin:0;">
                                    <?php echo csrf_field(); ?>
                        ...
                        <div class="notif-list">
                            <?php $__empty_1 = true; $__currentLoopData = $unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <a href="<?php echo e(route('admin.notifications.read', $notif->id)); ?>"
                                   class="notif-item unread"
                                   onclick="event.preventDefault(); document.getElementById('notif-form-<?php echo e($notif->id); ?>').submit();">
                                    <div class="notif-icon-wrap">
                                        <i class="fas fa-calendar-check"></i>
                                    </div>
                                    <div class="notif-content">
                                        <div class="notif-title"><?php echo e($notif->data['title'] ?? 'Notification'); ?></div>
                                        <div class="notif-msg"><?php echo e($notif->data['message'] ?? ''); ?></div>
                                        <div class="notif-time"><?php echo e($notif->created_at->diffForHumans()); ?></div>
                                    </div>
                                    <div class="unread-pip"></div>
                                </a>
                                <form id="notif-form-<?php echo e($notif->id); ?>" method="POST"
                                      action="<?php echo e(route('admin.notifications.read', $notif->id)); ?>" style="display:none;">
                                    <?php echo csrf_field(); ?>
                                </form>
