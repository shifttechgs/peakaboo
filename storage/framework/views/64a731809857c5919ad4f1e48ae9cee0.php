<?php $__env->startSection('title', 'Enrol Your Child — Peekaboo Daycare Parklands, Cape Town | Apply Online'); ?>
<?php $__env->startSection('description', 'Enrol your child at Peekaboo Daycare & Preschool in Parklands, Cape Town. Simple online application — takes 10 minutes. Accepting applications for 2026. Ages 3 months to Grade R.'); ?>
<?php $__env->startSection('keywords', 'enrol preschool Parklands 2026, daycare application Cape Town, register child daycare Parklands, enrol kindergarten Cape Town, preschool enrolment Cape Town northside'); ?>
<?php $__env->startSection('canonical', route('enrol.index')); ?>
<?php $__env->startSection('og_title', 'Enrol Your Child — Peekaboo Daycare Parklands, Cape Town'); ?>
<?php $__env->startSection('og_description', 'Apply online in 10 minutes. Peekaboo Daycare in Parklands, Cape Town is now accepting enrolments for 2026. Ages 3 months to Grade R.'); ?>
...
<script type="application/ld+json">
{
  ...
  "@type": "WebPage",
  "@id": "<?php echo e(route('enrol.index')); ?>#webpage",
  "url": "<?php echo e(route('enrol.index')); ?>",
  ...
  "breadcrumb": {
    ...
    "itemListElement": [
      ...
      {"@type": "ListItem", "position": 2, "name": "Enrol Now", "item": "<?php echo e(route('enrol.index')); ?>"}
    ]
  }
}
</script>
            ...
            <div class="row align-items-center gy-4">
                ...
                <div class="col-lg-7 wow itfadeUp" data-wow-duration=".9s">
                    <span class="pb-enrol-hero__badge">
                        <i class="fa-solid fa-heart"></i> Limited Spaces for <?php echo e(date('Y')); ?>
                    ...
                    <a href="<?php echo e(route('enrol.form')); ?>" class="pb-enrol-hero__cta">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64_3.3.4\www\projects\peekaboo\resources\views/public/enrol/index.blade.php ENDPATH**/ ?>