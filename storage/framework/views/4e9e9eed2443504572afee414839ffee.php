<?php $__env->startSection('title', 'Parents & Families'); ?>
...
<div class="row g-4 mb-4">
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <div class="value text-primary"><?php echo e($stats['total_parents']); ?></div>
                    <div class="label">Total Parents</div>
                </div>
                <div class="icon bg-primary bg-opacity-10 text-primary"><i class="fas fa-user-friends"></i></div>
            </div>
            <div class="mt-2 small text-muted"><?php echo e($stats['active_parents']); ?> active accounts</div>
        </div>
    </div>
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <div class="value text-success"><?php echo e($stats['total_children']); ?></div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <div class="value" style="color:#0097a7;"><?php echo e($stats['total_apps']); ?></div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <div class="value text-danger"><?php echo e($stats['total_parents'] - $stats['active_parents']); ?></div>
...
<div class="pnl">
    ...
    <div class="p-filter">
        <form method="GET" action="<?php echo e(route('admin.parents.index')); ?>">
            <div class="row g-3 align-items-end">
                <div class="col-md-6">
                    <label class="form-label">Search</label>
                    <input type="text" name="search" class="form-control"
                           placeholder="Name, email or phone…" value="<?php echo e(request('search')); ?>">
                </div>
                <div class="col-md-3">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center gap-3">
                            <div class="p-avatar"><?php echo e($initial); ?></div>
                            <div>
                                <div class="fw-semibold" style="color:#1a1f2e;"><?php echo e($parent->name); ?></div>
                                <div style="font-size:.76rem;color:#94a3b8;"><?php echo e($parent->email); ?></div>
                            </div>
                        </div>
                    </td>
                    <td>
                        <?php if($parent->phone): ?>
                            <span style="font-size:.83rem;color:#374151;">
                                <i class="fas fa-phone me-1 text-muted" style="font-size:.7rem;"></i><?php echo e($parent->phone); ?>
                    ...
                    <td>
                        <?php if($appCount > 0): ?>
                            <span class="p-pill" style="background:#e0f7fa;color:#0097a7;">
                                <i class="fas fa-file-alt me-1"></i><?php echo e($appCount); ?>
                    ...
                    <td style="font-size:.8rem;color:#94a3b8;">
                        <?php echo e($parent->created_at->format('d M Y')); ?>
                ...
                <tr>
                    <td colspan="6" class="text-center py-5">
                        ...
                        <?php if(request()->hasAny(['search','status'])): ?>
                            <a href="<?php echo e(route('admin.parents.index')); ?>" class="btn btn-sm btn-outline-secondary mt-2">Clear filters</a>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64_3.3.4\www\projects\peekaboo\resources\views/admin/parents/index.blade.php ENDPATH**/ ?>