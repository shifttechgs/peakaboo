...
<head>
    ...
    <title>New Password - Peekaboo</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-hint { font-size:.75rem; color:var(--text-tertiary); margin-top:6px; }
...
<body>
    <div class="auth-wrapper">
        <div class="auth-container">
            ...
            <div class="auth-card">
                <div class="auth-card-title">Choose a new password</div>
                <div class="auth-card-subtitle">Enter your new password below. Must be at least 8 characters.</div>
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" class="form-input"
                            value="{{ old('email', request()->email) }}" required autofocus autocomplete="email" readonly>
                    </div>
