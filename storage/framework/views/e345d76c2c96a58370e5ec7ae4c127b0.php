...
<body>
    ...
    <aside class="sb" id="sidebar">
        <div class="sb-brand">
            <div class="sb-brand-logo">
                <img src="<?php echo e(asset('assets/img/peekaboo/peekaboo_logo.png')); ?>" alt="Peekaboo"
                     onerror="this.src='<?php echo e(asset('assets/img/peekaboo/logo.png')); ?>'">
            </div>
            <div class="sb-brand-text">
                <span class="sb-brand-title">Peekaboo</span>
                <span class="sb-brand-subtitle"><?php echo $__env->yieldContent('portal-name', 'Parent Portal'); ?></span>
            </div>
        </div>
        ...
        <div class="sb-footer">
            <div class="sb-avatar"><?php echo e(strtoupper(mb_substr(auth()->user()->name, 0, 1))); ?></div>
            <div class="sb-footer-info">
                <span class="sb-footer-name"><?php echo e(auth()->user()->name); ?></span>
                <span class="sb-footer-role"><?php echo e(ucfirst(auth()->user()->getRoleNames()->first() ?? 'Parent')); ?></span>
            </div>
    ...
    <main class="portal-main">
        <header class="portal-header">
            <div class="hdr-left">
                ...
                <span class="hdr-page-title"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></span>
            </div>
            ...
            <div class="hdr-right">
                ...
                <div class="dropdown">
                    <div class="hdr-user" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="hdr-user-avatar"><?php echo e(strtoupper(mb_substr(auth()->user()->name, 0, 1))); ?></div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end hdr-dropdown">
                        ...
                        <li>
                            <a class="dropdown-item" href="<?php echo e(route('parent.fees.statements')); ?>">
    ...
    <div class="portal-toast success" id="toast"><i class="fas fa-check-circle me-2"></i><?php echo e(session('success')); ?></div>
    <?php endif; ?>
    <?php if(session('error')): ?>
    <div class="portal-toast error" id="toast"><i class="fas fa-exclamation-circle me-2"></i><?php echo e(session('error')); ?></div>
    <?php endif; ?>
