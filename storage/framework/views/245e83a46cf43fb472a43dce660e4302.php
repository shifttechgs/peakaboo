...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <span style="font-size:.76rem;color:#94a3b8;background:#f3f4f6;padding:6px 14px;border-radius:20px;">
        <i class="fas fa-calendar-alt me-1"></i><?php echo e(now()->format('d F Y')); ?>
...
<div class="row g-4 mb-4">
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <div class="value text-primary"><?php echo e($stats['apps_total']); ?></div>
            ...
            <div class="mt-2 small">
                <?php
                    ...
                    $up   = $pct >= 0;
                ?>
                <span class="<?php echo e($up ? 'text-success' : 'text-danger'); ?>">
                    <i class="fas fa-arrow-<?php echo e($up ? 'up' : 'down'); ?> me-1"></i><?php echo e(abs($pct)); ?>%
                </span>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <div class="value text-success"><?php echo e($stats['apps_approved']); ?></div>
            ...
            <div class="mt-2 small text-muted"><?php echo e($stats['apps_actionable']); ?> still need action</div>
        </div>
    </div>
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <div class="value" style="color:#0097a7;"><?php echo e($stats['leads_total']); ?></div>
            ...
            <div class="mt-2 small text-muted">
                <span style="color:#0097a7;font-weight:600;"><?php echo e($stats['conversion_rate']); ?>%</span> conversion rate
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <div class="value text-primary"><?php echo e($stats['total_parents'] + $stats['total_children']); ?></div>
            ...
            <div class="mt-2 small text-muted">
                <?php echo e($stats['total_parents']); ?> parents · <?php echo e($stats['total_children']); ?> children
            </div>
        </div>
    </div>
</div>
        ...
        <div class="rpt-panel" style="height:100%;">
            ...
            <div class="rpt-panel-body">
                ...
                <div class="rpt-pipeline mb-4">
                    ...
                    ?>
                    <?php $__currentLoopData = $pipeSegs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="rpt-pipe-seg">
                        <div class="rpt-pipe-seg__val" style="color:<?php echo e($seg['val'] > 0 ? $seg['color'] : '#d1d5db'); ?>;">
                            <?php echo e($seg['val']); ?>

                        </div>
                        <div class="rpt-pipe-seg__label"><?php echo e($seg['label']); ?></div>
                    </div>
                ...
                <div style="background:#fafafa;border-radius:12px;padding:14px 18px;display:flex;align-items:center;justify-content:space-between;gap:16px;">
                    <div class="text-center" style="flex:1;">
                        <div style="font-size:1.5rem;font-weight:800;color:#1a1f2e;line-height:1;"><?php echo e($stats['apps_this_month']); ?></div>
                    ...
                    <div class="text-center" style="flex:1;">
                        <div style="font-size:1.5rem;font-weight:800;color:#94a3b8;line-height:1;"><?php echo e($stats['apps_last_month']); ?></div>
                    ...
                    <div style="width:1px;height:40px;background:#e5e7eb;"></div>
                    <div class="text-center" style="flex:1;">
                        <div style="font-size:1.5rem;font-weight:800;<?php echo e($up ? 'color:#16a34a' : 'color:#ef4444'); ?>;line-height:1;">
                            <?php echo e($up ? '+' : ''); ?><?php echo e($pct); ?>%
                        </div>
    ...
    <div class="col-lg-5">
        <div class="rpt-panel" style="height:100%;">
            ...
            <div class="rpt-panel-body">
                ...
                ?>
                <?php $__empty_1 = true; $__currentLoopData = $stats['by_program']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prog => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                <div class="rpt-bar-row">
                    <div class="rpt-bar-label">
                        <span><?php echo e($prog); ?></span>
                        <span style="font-weight:800;color:<?php echo e($color); ?>;"><?php echo e($count); ?></span>
                    </div>
                    <div class="rpt-bar-track">
                        <div class="rpt-bar-fill" style="width:<?php echo e($pctW); ?>%;background:<?php echo e($color); ?>;"></div>
                    </div>
                </div>
    ...
    <div class="col-lg-5">
        <div class="rpt-panel" style="height:100%;">
            ...
            <div class="rpt-panel-body">
                ...
                <?php $w = round($step['val'] / $funnelMax * 100); ?>
                <div class="rpt-bar-row">
                    <div class="rpt-bar-label">
                        <span style="display:flex;align-items:center;gap:8px;">
                            <span style="width:10px;height:10px;border-radius:50%;background:<?php echo e($step['color']); ?>;display:inline-block;flex-shrink:0;"></span>
                            <?php echo e($step['label']); ?>

                        </span>
                        <span style="font-weight:800;color:<?php echo e($step['color']); ?>;"><?php echo e($step['val']); ?></span>
                    </div>
                    <div class="rpt-bar-track">
                        <div class="rpt-bar-fill" style="width:<?php echo e($w); ?>%;background:<?php echo e($step['color']); ?>;"></div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div style="margin-top:20px;padding-top:16px;border-top:1px solid #f3f4f6;display:flex;align-items:center;justify-content:space-between;">
                    ...
                    <span style="font-size:1.25rem;font-weight:800;color:<?php echo e($stats['conversion_rate'] >= 30 ? '#16a34a' : '#d97706'); ?>;">
                        <?php echo e($stats['conversion_rate']); ?>%
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="rpt-panel" style="height:100%;">
            ...
            <div class="rpt-panel-body">
                <div class="row g-3">
                    ...
                    ?>
                    <?php $__currentLoopData = $userSnap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $snap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-6">
                        <div style="background:#fafafa;border:1px solid #f0f0f0;border-radius:12px;padding:16px;display:flex;align-items:center;gap:14px;">
                            <div style="width:42px;height:42px;border-radius:12px;background:<?php echo e($snap['bg']); ?>;color:<?php echo e($snap['color']); ?>;display:flex;align-items:center;justify-content:center;font-size:.95rem;flex-shrink:0;">
                                <i class="fas <?php echo e($snap['icon']); ?>"></i>
                            </div>
                            <div>
                                <div style="font-size:1.4rem;font-weight:800;line-height:1;color:<?php echo e($snap['color']); ?>;"><?php echo e($snap['val']); ?></div>
                                <div style="font-size:.7rem;font-weight:700;text-transform:uppercase;letter-spacing:.4px;color:#94a3b8;margin-top:3px;"><?php echo e($snap['label']); ?></div>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="row g-4 mb-4">
    <div class="col-md-6 col-lg-4">
        <a href="<?php echo e(route('admin.reports.enrolment')); ?>" class="rpt-nav-card">
    ...
    <div class="col-md-6 col-lg-4">
        <a href="<?php echo e(route('admin.reports.payments')); ?>" class="rpt-nav-card">
    ...
    <div class="col-md-6 col-lg-4">
        <a href="<?php echo e(route('admin.reports.attendance')); ?>" class="rpt-nav-card">
...
<div class="rpt-panel">
    ...
    <div class="rpt-panel-body">
        <div class="row g-3">
            <div class="col-md-4">
                <a href="<?php echo e(route('admin.crm.leads.export')); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64_3.3.4\www\projects\peekaboo\resources\views/admin/reports/index.blade.php ENDPATH**/ ?>