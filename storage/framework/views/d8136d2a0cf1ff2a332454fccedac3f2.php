<?php $__env->startSection('title', 'Fee Schedule'); ?>
<?php $__env->startSection('portal-name', 'Parent Portal'); ?>
<?php $__env->startSection('page-title', 'Fee Schedule'); ?>
...
<div class="d-flex justify-content-between align-items-start mb-4">
    <div>
        ...
        <div style="font-size:.82rem;color:#94a3b8;margin-top:2px;">
            <?php echo e(now()->format('F Y')); ?> &mdash; billing overview and 2026 rate card
        </div>
    </div>
...
<div class="summary-bar">
    <div class="summary-tile">
        <div class="st-val">R <?php echo e(number_format($feeSummary['monthly_fee'], 0)); ?></div>
        <div class="st-lbl">Monthly Total</div>
        <div class="st-sub">Current plan</div>
    </div>
    <div class="summary-tile">
        <div class="st-val good">R <?php echo e(number_format($feeSummary['last_payment'], 0)); ?></div>
        <div class="st-lbl">Last Payment</div>
        <div class="st-sub"><?php echo e($feeSummary['last_payment_date'] ?? '—'); ?></div>
    </div>
    <div class="summary-tile">
        <div class="st-val <?php echo e($feeSummary['balance'] > 0 ? 'bad' : 'good'); ?>">
            R <?php echo e(number_format($feeSummary['balance'], 0)); ?>

        </div>
        <div class="st-lbl">Balance</div>
        <div class="st-sub"><?php echo e($feeSummary['balance'] > 0 ? 'Outstanding' : 'Up to date'); ?></div>
    </div>
    <div class="summary-tile">
        <div class="st-val <?php echo e(isset($feeSummary['next_due_days']) && $feeSummary['next_due_days'] <= 7 ? 'warn' : ''); ?>"
             style="font-size:1rem;">
            <?php echo e($feeSummary['next_due']); ?>

        </div>
        <div class="st-lbl">Next Due</div>
        <div class="st-sub">
            <?php if(isset($feeSummary['next_due_days']) && $feeSummary['next_due_days'] >= 0): ?>
                in <?php echo e($feeSummary['next_due_days']); ?> day(s)
...
<div class="panel">
    <div class="panel-header">
        ...
        <span style="font-size:.75rem;color:#94a3b8;"><?php echo e(now()->format('F Y')); ?></span>
    </div>
    <table class="table fee-table mb-0">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $feeLines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                <td>
                    <div class="d-flex align-items-center gap-2">
                        <div style="width:30px;height:30px;border-radius:8px;background:#f0f9ff;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:.8rem;color:#0077B6;flex-shrink:0;">
                            <?php echo e(strtoupper(substr($line['name'], 0, 1))); ?>

                        </div>
                        <span style="font-weight:700;color:#1a1f2e;"><?php echo e($line['name']); ?></span>
                    </div>
                </td>
                <td style="color:#64748b;"><?php echo e($line['program']); ?></td>
                <td>
                    <span style="background:#f0f9ff;color:#0077B6;font-size:.72rem;font-weight:700;padding:3px 9px;border-radius:999px;">
                        <?php echo e($line['fee_option']); ?>

                    </span>
                </td>
                <td class="text-end" style="font-weight:600;">R <?php echo e(number_format($line['base_fee'], 2)); ?></td>
                <td class="text-end">
                    <?php if($line['snack_box']): ?>
                        <span style="color:#16a34a;font-weight:600;">R <?php echo e(number_format($line['snack_fee'], 2)); ?></span>
                    <?php else: ?>
                        <span style="color:#d1d5db;">—</span>
                    <?php endif; ?>
                </td>
                <td class="text-end">
                    <span style="font-size:.95rem;font-weight:800;color:#1a1f2e;">R <?php echo e(number_format($line['total'], 2)); ?></span>
                </td>
            </tr>
            ...
            <tr class="fee-total-row">
                ...
                <td colspan="2" class="text-end">
                    <span style="font-size:1.1rem;font-weight:800;color:#0077B6;">
                        R <?php echo e(number_format($feeLines->sum('total'), 2)); ?>
                    ...
                    <div class="bank-val">
                        <?php if($children->count()): ?>
                            <span style="color:#0077B6;font-family:monospace;letter-spacing:.5px;">
                                <?php echo e($children->first()['child_number'] ?? $children->first()['reference']); ?>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64_3.3.4\www\projects\peekaboo\resources\views/parent/fees.blade.php ENDPATH**/ ?>