...
<div class="vs-menu-wrapper">
    <div class="vs-menu-area text-center">
        ...
        <div class="vs-mobile-menu">
            <ul>
                <li>
                    <a class="vs-svg-assets" href="<?php echo e(route('home')); ?>">
                        HOME
        ...
        <div style="padding: 20px 20px 0; display: flex; flex-direction: column; gap: 10px;">
            <a href="<?php echo e(route('enrol.index')); ?>"
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-auto">
                        <nav class="main-menu d-none d-lg-block">
                            <ul>
                                <li><a class="vs-svg-assets <?php echo e(request()->routeIs('home') ? 'active' : ''); ?>" href="<?php echo e(route('home')); ?>" style="color: var(--color-text, #0E2A46)">HOME</a></li>
                    ...
                    <div class="col-auto">
                        <div class="vs-header__action">
                            <div class="d-none d-xl-inline-flex gap-2">
                                ...
                                <a href="<?php echo e(route('enrol.index')); ?>" class="pb-header-btn pb-header-btn--primary">Enrol Now</a>
                            </div>
