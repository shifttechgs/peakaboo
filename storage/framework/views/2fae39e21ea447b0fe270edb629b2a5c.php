<?php $__env->startSection('title', 'Outstanding Payments'); ?>
...
<div class="d-flex justify-content-between align-items-start mb-4">
    <div>
        ...
        <div style="font-size:.82rem;color:#94a3b8;margin-top:2px;">
            Enrolled children with no verified payment for <?php echo e(\Carbon\Carbon::parse($currentMonth)->format('F Y')); ?>
...
<div style="background:#fff;border-radius:14px;border:1px solid #f0f0f0;box-shadow:0 1px 6px rgba(0,0,0,.05);overflow:hidden;">
    ...
    <table class="table mb-0" style="font-size:.84rem;">
        ...
        <tbody>
            ...
            <tr>
                <td style="padding:13px 20px;font-weight:700;color:#1a1f2e;border-bottom:1px solid #f9fafb;"><?php echo e($row['child_name']); ?></td>
                <td style="padding:13px 20px;border-bottom:1px solid #f9fafb;">
                    <code style="font-size:.78rem;color:#0077B6;"><?php echo e($row['child_number']); ?></code>
                </td>
                <td style="padding:13px 20px;border-bottom:1px solid #f9fafb;">
                    <div style="color:#374151;"><?php echo e($row['parent_name']); ?></div>
                    <div style="font-size:.73rem;color:#94a3b8;"><?php echo e($row['parent_email']); ?></div>
                </td>
                <td style="padding:13px 20px;border-bottom:1px solid #f9fafb;" class="text-end">
                    <span style="font-weight:700;color:#ef4444;">R <?php echo e(number_format($row['fee'], 2)); ?></span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="text-end" style="padding:12px 20px;background:#f8faff;border-top:2px solid #e0eeff;">
                    <span style="font-size:1rem;font-weight:800;color:#ef4444;">
                        R <?php echo e(number_format($outstanding->sum('fee'), 2)); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64_3.3.4\www\projects\peekaboo\resources\views/admin/payments/outstanding.blade.php ENDPATH**/ ?>