...
<?php $__env->startSection('page-title', 'Document Vault'); ?>
...
<div class="summary-bar">
    <div class="summary-tile">
        <div class="st-val"><?php echo e(count($childDocs)); ?></div>
        <div class="st-lbl"><?php echo e(Str::plural('Child', count($childDocs))); ?></div>
    </div>
    <div class="summary-tile">
        <div class="st-val"><?php echo e($totalDocs); ?></div>
        <div class="st-lbl">Required</div>
    </div>
    <div class="summary-tile">
        <div class="st-val good"><?php echo e($totalUploaded); ?></div>
        <div class="st-lbl">Uploaded</div>
    </div>
    <div class="summary-tile">
        <div class="st-val <?php echo e($totalMissing > 0 ? 'bad' : 'good'); ?>"><?php echo e($totalMissing); ?></div>
        <div class="st-lbl">Missing</div>
    </div>
</div>


<?php $__empty_1 = true; $__currentLoopData = $childDocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
<?php
...
<div class="panel">
    ...
    <div class="child-strip">
        <div class="child-strip-avatar"><?php echo e(strtoupper(substr($entry['child_name'], 0, 1))); ?></div>
        <div class="flex-grow-1">
            <div style="font-weight:800;font-size:.92rem;color:#1a1f2e;"><?php echo e($entry['child_name']); ?></div>
            <div style="font-size:.74rem;color:#64748b;">Ref: <?php echo e($entry['reference']); ?></div>
        </div>
        <div class="d-flex align-items-center gap-3">
            <div class="d-flex align-items-center gap-2" style="min-width:120px;">
                <div class="doc-progress-track">
                    <div class="doc-progress-fill" style="width:<?php echo e($pct); ?>%;"></div>
                </div>
                <span style="font-size:.72rem;font-weight:700;color:#64748b;white-space:nowrap;"><?php echo e($pct); ?>%</span>
            </div>
            <span class="progress-pill <?php echo e($pillClass); ?>">
                <i class="fas fa-<?php echo e($pillClass === 'complete' ? 'check-circle' : ($pillClass === 'partial' ? 'exclamation-circle' : 'times-circle')); ?>"></i>
                <?php echo e($entry['uploaded']); ?> / <?php echo e($entry['total']); ?>
    ...
    <?php $__currentLoopData = $entry['docs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php
        $iconClass = 'missing';
        if ($doc['uploaded']) {
    ...
    ?>
    <div class="doc-row">
        <div class="doc-icon <?php echo e($iconClass); ?>">
            <i class="fas <?php echo e($doc['uploaded'] ? ($iconClass === 'image' ? 'fa-file-image' : 'fa-file-pdf') : $docIcon); ?>"></i>
        </div>
        <div class="doc-body">
            <div class="doc-name"><?php echo e($doc['label']); ?></div>
            <?php if($doc['uploaded']): ?>
                <div class="doc-meta">
                    <i class="fas fa-check-circle me-1" style="color:#16a34a;font-size:.65rem;"></i>
                    Uploaded <?php echo e($doc['uploaded_at']); ?>

                    &bull; <?php echo e(strtoupper($doc['ext'])); ?>
        ...
        <div class="doc-actions">
            <?php if($doc['uploaded']): ?>
                ...
                <a href="<?php echo e(asset('storage/' . $doc['path'])); ?>" target="_blank" class="btn-upload">
                    <i class="fas fa-eye me-1"></i> View
                </a>
                <button type="button" class="btn-upload"
                        data-bs-toggle="modal" data-bs-target="#uploadModal"
                        data-app="<?php echo e($entry['app_id']); ?>"
                        data-type="<?php echo e($doc['type']); ?>"
                        data-label="<?php echo e($doc['label']); ?>"
...
<div class="modal fade" id="uploadModal" tabindex="-1" aria-labelledby="uploadModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius:16px;border:1px solid #f0f0f0;box-shadow:0 8px 40px rgba(0,0,0,.12);">
            ...
            <form method="POST" action="<?php echo e(route('parent.documents.upload')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64_3.3.4\www\projects\peekaboo\resources\views/parent/documents.blade.php ENDPATH**/ ?>