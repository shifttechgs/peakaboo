...
<body>
        ...
        <div class="auth-container">
            ...
            <div class="auth-brand">
                <div class="auth-brand-logo">
                    <img src="<?php echo e(asset('assets/img/peekaboo/logo.png')); ?>" alt="Peekaboo">
                </div>
    ...
    <div class="auth-footer">
        <div class="auth-footer-links">
            ...
            <span>•</span>
            <a href="<?php echo e(route('home')); ?>">Privacy</a>
            <span>•</span>
            <a href="<?php echo e(route('home')); ?>">Terms</a>
        </div>
    </div>
...
<?php /**PATH C:\wamp64_3.3.4\www\projects\peekaboo\resources\views/auth/login.blade.php ENDPATH**/ ?>