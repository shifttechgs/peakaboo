<?php $__env->startSection('title', 'Book a School Tour — Peekaboo Daycare Parklands, Cape Town'); ?>
<?php $__env->startSection('description', 'Book a free tour at Peekaboo Daycare in Parklands, Cape Town. Visit our facilities, meet our qualified teachers, and see our CAPS-aligned programmes in action. Tours available weekdays.'); ?>
<?php $__env->startSection('keywords', 'book daycare tour Parklands Cape Town, visit preschool Cape Town, school tour Peekaboo Daycare, childcare tour Cape Town northside, book tour preschool Parklands'); ?>
<?php $__env->startSection('canonical', route('book-tour')); ?>
<?php $__env->startSection('og_title', 'Book a Free School Tour — Peekaboo Daycare Parklands, Cape Town'); ?>
<?php $__env->startSection('og_description', 'Visit Peekaboo Daycare in Parklands, Cape Town. Tour our facilities, meet teachers, see our CAPS programmes. Book your free tour today.'); ?>
...
<script type="application/ld+json">
{
  ...
  "@type": "WebPage",
  "@id": "<?php echo e(route('book-tour')); ?>#webpage",
  "url": "<?php echo e(route('book-tour')); ?>",
  ...
  "breadcrumb": {
    ...
    "itemListElement": [
      ...
      {"@type": "ListItem", "position": 2, "name": "Book a Tour", "item": "<?php echo e(route('book-tour')); ?>"}
    ]
  }
}
</script>
            ...
            <div class="row align-items-center gy-4">
                <div class="col-lg-7 wow itfadeUp" data-wow-duration=".9s">
                    ...
                    <div class="pb-tour-hero__stats">
                        ...
                        <div class="pb-tour-hero__stat">
                            ...
                            <div>
                                <span class="pb-tour-hero__stat-number"><?php echo e(date('Y') - 2010); ?>+</span>
                ...
                <div class="col-lg-5 wow itfadeUp" data-wow-duration=".9s" data-wow-delay=".2s">
                    <div class="pb-tour-hero__img-wrap">
                        <img src="<?php echo e(asset('assets/img/class/class-1-1.jpg')); ?>" alt="Children enjoying arts and crafts at Peekaboo Daycare" class="pb-tour-hero__img">
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-8 mb-4 wow itfadeUp" data-wow-duration=".9s">
                    ...
                    <div class="pb-tour-form">
                        ...
                        <form action="<?php echo e(route('book-tour.submit')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="pb-input-wrap">
                                        <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" placeholder="e.g. Sarah Johnson" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="pb-input-wrap">
                                        <input type="tel" class="form-control" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="082 000 0000" required>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="pb-input-wrap">
                                        <input type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>" placeholder="you@example.com" required>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="pb-input-wrap">
                                        <input type="text" class="form-control" name="child_name" value="<?php echo e(old('child_name')); ?>" placeholder="Full name" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="pb-input-wrap">
                                        <input type="text" class="form-control" name="child_nickname" value="<?php echo e(old('child_nickname')); ?>" placeholder="Optional">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="pb-input-wrap">
                                        <select class="form-select" name="child_age" required>
                                            ...
                                            <option value="0-1" <?php echo e(old('child_age') == '0-1' ? 'selected' : ''); ?>>0–1 year (Baby Room)</option>
                                            <option value="1-3" <?php echo e(old('child_age') == '1-3' ? 'selected' : ''); ?>>1–3 years (Toddlers)</option>
                                            <option value="3-4" <?php echo e(old('child_age') == '3-4' ? 'selected' : ''); ?>>3–4 years (Preschool)</option>
                                            <option value="5-6" <?php echo e(old('child_age') == '5-6' ? 'selected' : ''); ?>>5–6 years (Grade R)</option>
                                        </select>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="hidden" name="preferred_date" id="preferred_date_input" value="<?php echo e(old('preferred_date')); ?>" required>
                                    ...
                                    <div class="row g-2">
                                        <div class="col-md-4">
                                            <label class="pb-time-slot">
                                                <input type="radio" name="preferred_time" value="09:00" <?php echo e(old('preferred_time', '09:00') == '09:00' ? 'checked' : ''); ?>>
                                                <span>
                                        ...
                                        <div class="col-md-4">
                                            <label class="pb-time-slot">
                                                <input type="radio" name="preferred_time" value="11:00" <?php echo e(old('preferred_time') == '11:00' ? 'checked' : ''); ?>>
                                                <span>
                                        ...
                                        <div class="col-md-4">
                                            <label class="pb-time-slot">
                                                <input type="radio" name="preferred_time" value="14:00" <?php echo e(old('preferred_time') == '14:00' ? 'checked' : ''); ?>>
                                                <span>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="pb-input-wrap">
                                        <textarea class="form-control" name="message" rows="3" placeholder="Tell us anything you'd like to know or see during your visit…"><?php echo e(old('message')); ?></textarea>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="pb-input-wrap">
                                        <select class="form-select" name="source">
                                            ...
                                            <option value="facebook" <?php echo e(old('source') == 'facebook' ? 'selected' : ''); ?>>Facebook</option>
                                            <option value="google" <?php echo e(old('source') == 'google' ? 'selected' : ''); ?>>Google Search</option>
                                            <option value="instagram" <?php echo e(old('source') == 'instagram' ? 'selected' : ''); ?>>Instagram</option>
                                            <option value="referral" <?php echo e(old('source') == 'referral' ? 'selected' : ''); ?>>Friend / Family Referral</option>
            ...
            <div class="modal-content">
                ...
                <div class="pb-modal__body">
                    ...
                    <div class="pb-modal__ref">
                        ...
                        <span class="pb-modal__ref-code"><?php echo e(session('booking_id')); ?></span>
                    </div>
                    <?php endif; ?>
...
(function () {
    ...
    // Submit loader
    const form    = document.querySelector('form[action="<?php echo e(route('book-tour.submit')); ?>"]');
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64_3.3.4\www\projects\peekaboo\resources\views/public/book-tour.blade.php ENDPATH**/ ?>